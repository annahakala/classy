#This is Christine Mcleavys midi parser
import argparse
import random
import os
import numpy as np
...
def main(chamber, composers, replace):
    ...
    PATH=BASE_PATH/'..'/'data'/'composers'/'midi'
    if chamber:
        PATH=PATH/'chamber'
    else:
    ...
    CHORDWISE_PATH=BASE_PATH/'..'/'data'/'composers'/'chordwise'
    NOTEWISE_PATH=BASE_PATH/'..'/'data'/'composers'/'notewise'
